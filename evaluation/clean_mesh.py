...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_dir', dest='root_dir', type=str, default='/data/pengr/DTU_TEST',
        help='dataset')
    ...
    parser.add_argument('--set', dest='set', type=int, default=1)
    ...
    for scan in scans:
        ...
        old_mesh_file = glob(os.path.join(args.out_dir, "*scan%d_epoch0.ply"%scan))[0]
