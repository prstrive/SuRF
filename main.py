...
parser = argparse.ArgumentParser(description="SparseRecon args")
...
parser.add_argument('--scene', type=str, default=None, help='for finetune')
parser.add_argument('--ref_view', type=int, default=None, help='for finetune')
parser.add_argument("--load_vol", action="store_true")
